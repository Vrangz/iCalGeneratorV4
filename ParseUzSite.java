...
public class ParseUzSite extends JApplet {
	public ArrayList<String> startHourArray = new ArrayList<>();
	public ArrayList<String> endHourArray = new ArrayList<>();
...
//	public static void main(String args[]) {}
						...
						try {
							...
							if(date.charAt(0) == '0' || date.charAt(0) == '1' ||
								...
								try {
									...
									nameArray.add(temp.child(3).text());
							}
							k = 1;
							break;
	...
	public String printEvents() {
		String allEvents = "" + startHourArray.size();
		for(int i = 0; i < startHourArray.size(); i++)
			allEvents += startHourArray.get(i) + " - " + endHourArray.get(i) + "   " + nameArray.get(i) + "\n";
		return allEvents;
	}
